<%-- 
    Document   : leOrganisateur
    Created on : Jan 3, 2023, 2:35:58 PM
    Author     : matti
--%>
...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>Organisateur — gestionDefile</title>
    </head>
    <body>
        <c:choose>
        <c:when test="${!empty sessionScope.roleAccount }">
            <% Organisateur o = (Organisateur) request.getAttribute("organisateur"); %>
            ...
            <div class="content">
                <center><h1>Informations sur l'organisateur</h1></center>
                ...
                <div class="container">
                    ...
                    <div class="info">
                        <p><b>Nom :</b> <%= o.getPrenom() %> <%= o.getNom() %></p><br>
                        <p><b>Société :</b> <%= o.getNomSociete() %></a></p><br>
                        <p><b>Téléphone :</b> <%= o.getTelephone()%></p><br>
                        <p><b>Localisation :</b> <%= o.getCp() %> <%= o.getVille() %></a></p><br>
                    </div>
                </div>
            </div>
        </c:when>
