<%-- 
    Document   : searchByCout
    Created on : Jan 7, 2023, 3:17:41 PM
    Author     : matti
--%>
...
<html>
    ...
    <body>
            ...
            <% Double coutSearch = (Double) request.getAttribute("coutSearch"); %>
            <% Double delta = (Double) request.getAttribute("delta"); %>
            ...
            <div class="content">
                <center>
                    ...
                    <p>Affichage des défilés ayant un coût de <%= coutSearch %> (à ±<%=delta%>)</p><br>
                </center>
                ...
                <div class="table">
                    ...
                    <% for (Defile d :leDefile) {
                        if((defileCoutMap.get(d) > (coutSearch - delta)) && (defileCoutMap.get(d) < (coutSearch + delta)) && (defileCoutMap.get(d) > 0)) {
