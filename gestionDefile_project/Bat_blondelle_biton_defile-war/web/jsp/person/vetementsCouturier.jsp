<%-- 
    Document   : vetementsCouturier
    Created on : Jan 3, 2023, 3:01:22 PM
    Author     : matti
--%>
...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>Mes vêtements — gestionDefile</title>
    ...
    <body>
        ...
        <c:when test="${sessionScope.roleAccount == 'couturier'}">
            ...
            <div class="content">
                <center><h1>Mes vêtements</h1></center>
                ...
                <div class="table">
                    ...
                    <tr>
                      ...
                      <td><a href="servletDefile?id=<%= v.getLeMannequin().getId() %>&action=infosMannequin" target="_blank"><%= v.getLeMannequin().getPrenom() %> <%=v.getLeMannequin().getNom() %></a></td>
                      ...
                      <td>
                          <% double vetementTotal = v.getPrixVetement() + v.getLeBijoux().getPrixAchat() + v.getLeBijoux().getPrixLoc() + v.getLeBijoux().getPrixAssurance() + v.getLesChaussures().getPrixAchat() + v.getLesChaussures().getPrixLoc() + v.getAccessoireVestimentaire().getPrixAchat() + v.getAccessoireVestimentaire().getPrixLoc(); %>
                          <%= vetementTotal %>
                      </td>
                    </tr>
                    <% } %>
